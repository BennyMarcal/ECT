...
public class POO1920EN {
	...
	private static void alinea1(PrintStream out) {
		...
		tlm1.addNota("Melhor Compra 2019"); tlm1.addNota("Em promoçao");
		...
		out.println("Descrisçao de electr1 :"+electr1.getDescricao());
		//  adicionar � Loja
		...
		out.println("Informaçaoo sobre Frigorifico:");
		...
		out.println("Informaçao sobre Telemovel:");
	...
	private static void alinea2(PrintStream out) {
		...
		if (loja != null) {
			...
			out.println("Lista de Electrodomesticos com Classe A:");
