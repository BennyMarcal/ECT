...
* Cada fornecedor é caracterizado por um nome, únmero de informação fiscal, endereço, número de fax, condições de pagamento (pronto, 30 dias, 60 dias, etc) e um código interno do tipo de fornecedor (ao qual está, por sua vez, associada uma designação); 
...
```
Produtos 
    -> Atributos: Código, Nome, Preço, Taxa de IVA, Quantidade

Encomenda
    -> Atributos: Número da encomenda, Data, Fornecedor unico, Produto/Produtos

Fornecedor
    -> Atributos: Código, Nome, Nif, Endereço, Número de fax, Condição de pagamento, Código interno do tipo de fornecedor

Tipo Fornecedor
    -> Atributos: Código, Designação
```
