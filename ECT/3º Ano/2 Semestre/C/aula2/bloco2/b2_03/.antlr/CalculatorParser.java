// Generated from c:\Users\benny\Desktop\ECT\3º Ano\2 Semestre\C\aula2\bloco2\b2_03\Calculator.g4 by ANTLR 4.9.2
...
public class CalculatorParser extends Parser {
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__4:
				...
				_prevctx = _localctx;
				setState(25);
				((ExprUnaryContext)_localctx).value = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==T__3 || _la==T__4) ) {
					((ExprUnaryContext)_localctx).value = (Token)_errHandler.recoverInline(this);
				}
				else {
	...
	public static final String _serializedATN =
		...
		"\31\5\6\4\2\31\32\7\t\2\2\32\36\3\2\2\2\33\34\t\2\2\2\34\36\7\n\2\2\35"+
