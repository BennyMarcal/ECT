// Generated from c:\Users\benny\Desktop\ECT\3º Ano\2 Semestre\C\aula2\bloco2\b2_02\SuffixCalculator.g4 by ANTLR 4.9.2
...
public class SuffixCalculatorParser extends Parser {
	...
	public static class ExpSuffixContext extends ExprContext {
		public Token op;
		...
		public ExpSuffixContext(ExprContext ctx) { copyFrom(ctx); }
	}
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					{
					{
					_localctx = new ExpSuffixContext(new ExprContext(_parentctx, _parentState));
					...
					expr(0);
					setState(24);
					((ExpSuffixContext)_localctx).op = _input.LT(1);
					_la = _input.LA(1);
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__2) | (1L << T__3))) != 0)) ) {
						((ExpSuffixContext)_localctx).op = (Token)_errHandler.recoverInline(this);
					}
					else {
